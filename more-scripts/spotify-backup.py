...
def main():
   ...
   if args.token:
      ...
      readclientid = open("/home/tony/.keys/spotify-client-id", "r").read().rstrip()
      spotify = SpotifyAPI.authorize(client_id=readclientid, scope='playlist-read-private')
   ...
   for playlist in playlists:
       ...
       for track in playlist['tracks']:
          print('{name}\t{artists}\t{album}\t{uri}'.format(
             uri=track['track']['uri'],
